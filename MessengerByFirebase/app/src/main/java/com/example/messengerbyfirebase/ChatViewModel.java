...
public class ChatViewModel extends ViewModel {
    ...
    private MutableLiveData<String> eror = new MutableLiveData<>();
    ...
    public LiveData<String> getEror() {
        return eror;
    }

    public void setUserOnline(boolean isOnline){
        referenceUsers.child(currentUserId).child("online")
                .setValue(isOnline);
    }
